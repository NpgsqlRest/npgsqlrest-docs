...
description: "On AI tools, the people behind NpgsqlRest, and how this documentation was built."
---

# About This Website

This website is built and maintained with substantial help from AI tools — primarily [Claude](https://claude.ai).
...
The project itself is a different story. The C# library, parser, code generator, and runtime are **hand-written** — more than two years of evenings and weekends — and covered by **2,400+ integration tests** running against real PostgreSQL. The AI-assisted part is the website you're reading; the thing it documents is not.
