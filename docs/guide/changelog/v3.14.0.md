---
description: "NpgsqlRest v3.14.0: This release sharpens the philosophy of the standalone client: REST endpoints come from PostgreSQL routines (functions, procedures) and…"
---
...
#### Estimated impact on the [PostgreSQL REST API benchmark](/blog/benchmarks-2026-07/) workloads
