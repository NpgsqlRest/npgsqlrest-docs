---
description: "NpgsqlRest v3.1.2: Release notes: Performance: SIMD-Accelerated String Processing; Consistent JSON Error Responses; EnvFile Configuration Option; TsClient…"
---
