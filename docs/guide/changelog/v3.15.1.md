---
description: "NpgsqlRest v3.15.1: Two bug fixes around config-key validation that together caused legitimate Auth:Schemes setups to fail startup under default settings. No…"
---
