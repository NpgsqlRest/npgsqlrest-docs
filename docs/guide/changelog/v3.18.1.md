---
description: "NpgsqlRest v3.18.1: Patch release that makes all automatic (server-filled) parameters forward to proxy endpoints consistently, in the endpoint's native…"
---
