---
description: "NpgsqlRest v3.0.1: Fixes missing stack traces in AOT builds and the Docker JIT image build; PostgreSQL error 42883 now maps to HTTP 500 instead of 404."
---
