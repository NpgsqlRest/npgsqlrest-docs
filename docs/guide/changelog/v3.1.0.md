---
description: "NpgsqlRest v3.1.0: Release notes: Http Types; Routine Caching Improvements; Multi-Host Connection Support; Other Changes and Fixes"
---
...
- Fixed type on TypeScript client generation when returning error. Errors now return JSON object instead of string.
