---
description: "NpgsqlRest v3.11.1: Release notes: TsClient: proxy Passthrough Endpoint Support; authorize Annotation Now Matches User ID and User Name Claims"
---
