---
description: "NpgsqlRest v3.0.0: Release notes: Docker JIT Version; .NET 10 Target Framework; TsClient (Code Generation) Improvements; Info Events Streaming Changes…"
---
